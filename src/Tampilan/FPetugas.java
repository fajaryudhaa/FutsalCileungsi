...
private String trans;
    ...
    private void isiGrid() {
        ...
        RsLpg = KoneksiDB.getRS("select * from petugas");
        try {
            while (RsLpg.next()) {
            ...
            Logger.getLogger(FPetugas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/Employee Card_40px.png"))); // NOI18N
    ...
    private void TTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TTableMouseClicked
        ...
        if (petugas.caripetugas(TTable.getValueAt
            (TTable.getSelectedRow(),0).toString())==true) {
        TKode.setText(petugas.getNama());
        txtalamat.setText(petugas.getAlamat());
        THarga.setText(petugas.getNotlp());
        }
    ...
    private void BSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSimpanActionPerformed
        ...
        if (petugas.updatepetugas(trans,plg)>0){
            javax.swing.JOptionPane.showMessageDialog(this, "Data Petugas Telah Disimpan");
            emptyText();
            isiGrid();
        }
    ...
    private void BUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BUbahActionPerformed
        ...
        String[] plg={TKode.getText(),txtalamat.getText(),THarga.getText()};
        if (petugas.updatepetugas(trans,plg)>0){
            javax.swing.JOptionPane.showMessageDialog(this, "Data Petugas Telah Diubah");
            emptyText();
            isiGrid();
        }
        else{javax.swing.JOptionPane.showMessageDialog(this,
    ...
    private void BhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BhapusActionPerformed
        ...
        if(petugas.updatepetugas(trans, plg)>0) {
            javax.swing.JOptionPane.showMessageDialog(this, "Data Petugas Telah Terhapus");
            emptyText();
            isiGrid();
        } else {
